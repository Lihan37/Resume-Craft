    ...
    <div className="">
      ...
      <div className="border-2 border-gray-300 rounded-bl-2xl rounded-br-2xl p-4 md:p-3 lg:p-5">
        <div className="flex gap-4 font-semibold mb-3">
          <p className="bg-[#f8e9e9] px-4 md:px-3 lg:px-4 py-2 md:py-[4px] lg:py-2 rounded-xl">News</p>
          <p className="bg-[#c8e6f5] px-4 md:px-3 lg:px-4 py-2 md:py-[4px] lg:py-2 rounded-xl">Inspiration</p>
        </div>
