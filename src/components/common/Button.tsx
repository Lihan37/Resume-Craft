...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      shadow-2xl flex justify-start items-center gap-8 uppercase font-mono hover:gap-10 transition-all duration-300 px-8 pr-3 border-2 py-2 xl:py-3 rounded-full font-semibold tracking-widest	text-base xl:text-lg`}>
      <span> {children}</span>
      <span
        className={`
