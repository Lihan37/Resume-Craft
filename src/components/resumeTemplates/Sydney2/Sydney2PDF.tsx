...
const Sydney2PDF: React.FC<ISydney2> = ({ }) => {
    const style = styleSydney2.require;
    ...
    const styles = StyleSheet.create({
        container: styleSydney2.common.container,
        header: {
            display: "flex",
            flexDirection: "row",
            gap: "5px",
        },
        headerViewOne: { ...styleSydney2.common.headerDivOne, flex: 1 },
        headerViewTwo: styleSydney2.common.headerDivTwo,
        firstName: {
        ...
        imageAva: styleSydney2.common.Image,
        headerIcon: {
            display: "flex",
            flexDirection: "row",
            gap: "10px",
                            ...
                            <View>
                                {resume.skills.map((item) => {
                                    return (
                                        item.label && (
                                            <View  key={item._id}>
                                                <Text style={{...style.skills.label,
                                                        textAlign: style.skills.label.textAlign as any}}>{item.label}</Text>
                                                {!skillLevelHide && (
                                                    <View style={styles.skillsLevelContainer}>
                                                        {createArrayUpToNumber(item.level / 20).map((i) => (
                                                            <View key={i} style={styleCommon.skillsLevel}></View>
                                                        ))}
                                                    </View>
                                                )}
                                            </View>
