    ...
    >
      ...
      <div className="mt-6 items-center ">
        <div className="lg:flex md:flex justify-center lg:justify-center md:justify-center mb-2">
          <div className="items-center lg:flex md:flex font-semibold">Title:</div>
          <input
            type="text"
            className="lg:w-3/4 
            border-xl w-full
        ...
        <div className="lg:flex md:flex justify-center lg:justify-center md:justify-center mb-2">
          <div className="items-center lg:flex md:flex font-semibold">Image:</div>
          <div
        ...
        lg:justify-center md:justify-center mb-2">
          <label className="items-center lg:flex md:flex font-semibold">Editor:</label>
          <input
            type="text"
            className="lg:w-3/4
            hover:border-indigo-500 hover:bg-gray-100
        ...
        items-center
        lg:justify-center md:justify-center mb-2">
          <label className="items-center lg:mr-2 md:mr-2 lg:flex md:flex font-semibold">Tags:</label>
          <div>
