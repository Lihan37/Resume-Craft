...
const HeroSection: React.FC = () => {
  return (
    <div>
      <div className=" text-black lg:flex lg:flex-row flex flex-col-reverse items-center justify-center bg-cover bg-center" style={{ backgroundImage: 'url("https://i.ibb.co/NNZ8RQr/hero-bg.png")' }}>
        <div className=" flex-1">
          ...
          <a href="" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 inline-block">Build Your Resume</a>
        </div>
        <div className="flex-1">
